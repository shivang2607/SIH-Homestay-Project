...
import { BiBus, BiFemale, BiMale } from 'react-icons/bi';
import { FaChild } from 'react-icons/fa';
import { GiCommercialAirplane } from 'react-icons/gi';
import { MdDirectionsRailwayFilled, MdGroups, MdLocationCity, MdLocationPin } from 'react-icons/md';
import { v4 } from "uuid";
                        ...
                        {details.Capacity - details.booked_guests != 0 && <div className={styles.maindiv}>
                            ...
                            <div className={styles.selection_div}>
                                <div className={styles.totalprice_div}>
                                    ...
                                    <div className={styles.price_heading}><p > Total Rent</p></div>
                                    <div className={styles.totalrent}><p className={styles.dates}> {diffrecnedate} x {details.pricePerNight}</p>
                                        <p className={styles.total_price1}> ₹ {price}</p>
                                        <p className={styles.number_guests}> {guests}(Guests)</p></div>
                                </div>
