        ...
        <div className={styles.house_details}>
            ...
            {details.URLS && (
              <>
                <div className={styles.gallery_img2}>
                  <img src={details.URLS[0]}></img>
                </div>
                <div className={styles.gallery_img3}>
                  <img src={details.URLS[1]}></img>
                </div>
                <div className={styles.gallery_img4}>
                  <img src={details.URLS[2]}></img>
                </div>
          ...
          <div className={styles.station_details}>
            ...
            <div className={styles.railway}>
              ...
              <MdDirectionsRailwayFilled size={30} color="rgb(42, 132, 150)" />
                        ...
                        <div className={styles.box_top}>
                          <div className={styles.profile}>
                            ...
                            <div className={styles.name_user}>
                              <strong>
                                {/*comment.user.name*/}DIKSHA SINGLA ..{" "}
                                <ReactTimeAgo
                                  date={
                                    new Date(
