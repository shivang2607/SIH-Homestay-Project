...
function HomeStay({ details, homestayId }) {
    ...
    const { addComment, addRating, useAuth, bookHomestay } = useFirebase();
    const { user } = useAuth();
    ...
    async function booknow(e) {
        ...
        await bookHomestay("diksha@gmail.com", details.host.email, details.docid, "diksha singla", "987715365462", details.host.phone, details.homestayName, startDate, stopDate, Number(guest), price, details.city, details.address);
                    ...
                    <div className={styles.header_div}>
                        ...
                        <div className={styles.aisehi}>
                            ...
                            <div className={styles.guests_div}>
                                ...
                                <input placeholder="Guests" className={styles.placeholder_guets} type="number" min="1" />
                            </div>
                            ...
                            <div className={styles.seacrh_button}>
                                <Button colorScheme='teal' fontSize='1.2rem' variant='outline' size='md' marginTop='0.2rem'  onClick={() => {
                                    router.push({
                ...
                <div className={styles.small_detials}>
                    <div className={styles.sub_div}>
                        ...
                        <p><MdGroups size={40} /><span className={styles.text_guests}> Available Capacity&nbsp;&nbsp;&nbsp;
                            {console.log("these are bookoed guests", details.booked_guests)}
